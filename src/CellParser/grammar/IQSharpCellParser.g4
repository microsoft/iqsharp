...
parser grammar IQSharpCellParser;

options {
    tokenVocab = QSharpLexer;
}

// We modify the definition of document from the original grammar to allow for
// the more general declarations that can occur in an IQ# cell.
cellPart
    : namespace
    | namespaceElement
    ;

cell : cellPart* eof=EOF;
