...
namespace Microsoft.Quantum.IQSharp.AzureClient
{
    ...
    /// </summary>
    public class StatusMagic : MagicSymbol
    {
        /// <summary>
        ...
        public async Task<ExecutionResult> RunAsync(string input, IChannel channel)
        {
            ...
            if (keyValuePairs.Keys.Count > 0)
            {
                ...
                return await AzureClient.PrintJobStatusAsync(channel, jobId).ToExecutionResult();
            }

            return await AzureClient.PrintJobListAsync(channel).ToExecutionResult();
        }
    }
}