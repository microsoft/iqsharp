...
namespace Microsoft.Quantum.IQSharp.AzureClient
{
    ...
    public interface IAzureClient
    {
        ...
        /// </returns>
        public Task<ExecutionResult> SubmitJobAsync(IChannel channel, string operationName, string jobName, int shots, Dictionary<string, string> inputParameters);
        ...
        /// </returns>
        public Task<ExecutionResult> ExecuteJobAsync(IChannel channel, string operationName, string jobName, int shots, Dictionary<string, string> inputParameters);
