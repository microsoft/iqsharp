...
namespace Microsoft.Quantum.IQSharp.AzureClient
{
    ...
    internal static class Resources
    {
        ...
        public const string AzureClientErrorInvalidTarget =
            "The specified target is not enabled in your workspace. Please make sure the target name is valid and that the associated provider is added to your workspace. To add a provider to your quantum workspace in the Azure Portal, see https://aka.ms/AQ/Docs/AddProvider";
