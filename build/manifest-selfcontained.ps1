...
@{
    Assemblies = @(
        ...
        "linux-x64/Microsoft.Quantum.IQSharp.ExecutionPathTracer.dll",
        ...
        "osx-x64/Microsoft.Quantum.IQSharp.ExecutionPathTracer.dll",
        ...
        "win10-x64/Microsoft.Quantum.IQSharp.ExecutionPathTracer.dll",
